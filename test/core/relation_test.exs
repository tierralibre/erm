defmodule Erm.Core.RelationTest do
  ...
  test "relations are listed by type and to" do
    ...
    entities =
      Relation.list_relations(app.name, app.persistence, "belongs_category", %{to: cat.id})
  ...
  test "relations are listed by type and from" do
    ...
    entities =
      Relation.list_relations(app.name, app.persistence, "belongs_category", %{from: pr.id})
  ...
  test "relations are listed by type and from and to" do
    ...
    entities =
      Relation.list_relations(app.name, app.persistence, "belongs_category", %{
        from: pr.id,
        to: cat.id
      })
